...
#define IDEAL_MAPPING 0
#define CMT_SIZE 4 * 1024 * 1024 // bytes
...
#define GLOBAL_WB_SIZE (NAND_CHANNELS * LUNS_PER_NAND_CH * ONESHOT_PAGE_SIZE * 8)
#define WRITE_EARLY_COMPLETION 1
